      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto lg:mx-0 mb-8 opacity-0 animate-fade-in animation-delay-600">
              Specializing in GenAI, Computer Vision, and NLP. Transforming complex problems 
              into elegant AI-powered solutions with 4+ years of experience.
            </p>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4 opacity-0 animate-fade-in animation-delay-600">
              <a
                ...
                className="p-3 bg-secondary hover:bg-primary/20 border border-border hover:border-primary/50 rounded-lg transition-all duration-300"
              >
                <Github size={20} />
              </a>
              <a
              ...
              <a
                href="#contact"
                className="ml-2 px-6 py-3 bg-primary text-primary-foreground font-medium rounded-lg hover:opacity-90 transition-opacity glow-sm"
              >
                Get in Touch
              </a>
            </div>
